       ...
       <div className="flex items-center gap-4">
          ...
          {user ? (
            <div className="relative">
                ...
                >
                    {user.image || user.avatarUrl || (user.photos && user.photos[0]) ? (
                        <img 
            ...
            <button 
                ...
                aria-label="Login"
            >
                <span className="text-sm font-medium text-gray-600 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white">Login</span>
